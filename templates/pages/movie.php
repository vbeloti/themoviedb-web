        ...
        <div class="content__center__box">
            <?php foreach (array_slice($data['similars'], 0, 6) as $similars) { ?>
                <div class="content__center__similars_item">
                    ...
                    <a href="<?= correctPath(); ?>movie/<?= $similars->id ?? ''; ?>"><img src="<?= isset($similars->image)  ? "https://image.tmdb.org/t/p/original{$similars->image}" : 'https://www.cowgirlcontractcleaning.com/wp-content/uploads/sites/360/2018/05/placeholder-img-4.jpg'; ?>" alt=""></a>
                </div>
            <?php } ?>
        </div>
    </div>
